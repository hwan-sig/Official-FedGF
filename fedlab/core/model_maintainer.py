...
class ModelMaintainer(object):
    ...
    def set_model_np(self, parameters: torch.Tensor):
        """Assign parameters to self._model."""
        SerializationTool.deserialize_trainable_model(self._model, parameters)
    ...
    @property
    def model_parameters_np(self) -> torch.Tensor:
        """Return serialized model parameters."""
        return SerializationTool.serialize_trainable_model(self._model)
