...
from ...utils.dataset.partition import CIFAR100Partitioner
import pandas as pd
from pathlib import Path

# JSON_PATH = "/home/Hwan/FedLab/fedlab/contrib/json_data/cifar100/federated_train_alpha_"
...
class PartitionedCIFAR100(FedDataset):
    ...
    def preprocess(self,
        ...
        trainset = torchvision.datasets.CIFAR100(root=self.data_root,
                                                train=True,
        ...
        if self.json_path:
            ...
            for u_idx, img, img_cls, x, y in zip(df['user_id'].values, df['image_id'].values, df['class'], samples,
                                                 labels):
    ...
    def load_dataset(self, cid, type="train"):
